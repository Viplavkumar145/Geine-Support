...
def create_app():
    ...
    This allows for better organization and testability.
    """
    ...
    async def get_ai_response(message: str, session_id: str, brand_tone: str = "friendly") -> tuple[str, bool, float]:
        ...
        try:
            ...
            # The OpenAI client will now handle this using the OPENAI_API_KEY environment variable.
            
            # Initialize the OpenAI client
            # The client will automatically use the OPENAI_API_KEY from your .env file
            client = OpenAI()

            # Create the conversation history for the API call
            messages = [
            ...
            # --- FIX: The above line was missing 'await' ---
