                      ...
                      <Card className="glass-card overflow-hidden relative">
                        ...
                        <CardContent className="p-6 relative z-10 text-white">
                          <div className="text-center space-y-3">
                            ...
                            <p className="text-white opacity-90 text-sm">Your SupportGenie is online and ready to help customers 24/7</p>
                          </div>
                        </CardContent>
                      </Card>
                    </div>
            ...
            <footer className="bg-white border-t border-gray-100 px-6 py-4">
              <div className="flex items-center justify-between text-sm text-gray-500">
                <div className="flex items-center gap-2">
                  ...
                  <span>Developed with passion for exceptional customer support</span>
                </div>
